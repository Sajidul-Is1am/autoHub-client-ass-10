...
const AddProduct = () => {
    ...
    const handleSubmit = event => {
        ...
        fetch('https://autohub-brand-shop-server-1xi8c9bdl-mds040772-gmailcom.vercel.app/products', {
            method: "POST",
            headers: {
        ...
        <div className="lg:mx-96 md:mx-16 mx-10 rounded-xl my-8 bg-gray-200">
            ...
            <form onSubmit={handleSubmit} className="p-10 border">
                <div className="grid justify-center gap-6 md:grid-cols-2 grid-cols-1 ">
                    <input type="text" placeholder="Image Link" name="image" className="input input-bordered lg:col-span-2" required/>
                    <input type="text" placeholder="Name" name="name" className="input input-bordered " required/>
                    <input type="text" placeholder="Brand Name" name="brandname" className="input input-bordered " required/>
                    <input type="text" placeholder=" category" name="category" className="input input-bordered ;lg:col-span-2" required/>

                    <input type="text" placeholder="Short description" name="description" className="input input-bordered lg:col-span-2" required/>
